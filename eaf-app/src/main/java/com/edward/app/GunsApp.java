...
public class GunsApp {
    ...
    public static final HttpApi POST_GUNS_ACCOUNT_ADD = new HttpApi(GUNS_ACCOUNT_ADD_PATH, HttpMethod.POST_FORM);
    public static final String GUNS_ROLE_TREE_LIST_BY_USERID_PATH = "GUNS/role/roleTreeListByUserId";
    public static final HttpApi POST_GUNS_ROLE_TREE_LIST_BY_USERID = new HttpApi(GUNS_ROLE_TREE_LIST_BY_USERID_PATH, HttpMethod.POST_FORM);
