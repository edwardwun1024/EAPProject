package com.edward.http.builder;

import com.edward.http.common.SSLs;
...
//		this.isNewSSL=true;
    ...
    public HCB pool(int maxTotal, int defaultMaxPerRoute) throws HttpProcessException{
        Registry<ConnectionSocketFactory> socketFactoryRegistry = RegistryBuilder
                .<ConnectionSocketFactory> create()
                .register("com/edward/http", PlainConnectionSocketFactory.INSTANCE)
    ...
    public HCB proxy(String hostOrIP, int port){
        // 依次是代理地址，代理端口号，协议类型
        HttpHost proxy = new HttpHost(hostOrIP, port, "com/edward/http");
